...
```javascript
import isUnityProbabilityArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-unity-probability-array@v0.2.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-unity-probability-array/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/assert-is-unity-probability-array/actions/workflows/test.yml?query=branch:v0.2.0
